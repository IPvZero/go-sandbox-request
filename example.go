...
type Response struct {
	Name string `json:"Cisco-IOS-XE-native:hostname"`
}
...
func main() {
	...
	req, err := http.NewRequest(http.MethodGet,
		"https://sandbox-iosxe-latest-1.cisco.com:443/restconf/data/native/hostname",
		http.NoBody)
	if err != nil {
		log.Fatal(err)
	}
	...
	fmt.Println("The device name on this Sandbox is", yang.Name)
